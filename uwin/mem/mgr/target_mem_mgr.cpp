    ...
    namespace mem {
        namespace mgr {
            ...
            pages_regions_container::iterator target_mem_mgr::find_containing_win32(tmem_region region) {
                ...
                if (it == _regions_container.end()) throw win32::error(win32::error_code::ERROR_INVALID_ADDRESS,
            ...
            tmem_region target_mem_mgr::reserve_fixed(tmem_region region) {
                return *_regions_container.insert(region.align_greedy(consts::allocation_granularity, consts::page_size)); // NOLINT(cppcoreguidelines-slicing)
            }
