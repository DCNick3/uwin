...
public:
    ...
    ~kstruct_error() noexcept override = default;;
...
public:
    explicit undecided_endianness_error(const std::string& src_path):
        kstruct_error("unable to decide on endianness for a type", src_path)
    {
    }

    ~undecided_endianness_error() noexcept override = default;;
};
...
// "at pos #{io.pos}: validation failed: #{msg}"
    ...
    ~validation_failed_error() noexcept override = default;;
...
public:
    ...
    ~validation_not_equal_error<T>() noexcept override = default;;
...
public:
    ...
    ~validation_less_than_error<T>() noexcept override = default;;
...
public:
    ...
    ~validation_greater_than_error<T>() noexcept override = default;;
...
public:
    ...
    ~validation_not_any_of_error<T>() noexcept override = default;;
...
public:
    ...
    ~validation_expr_error<T>() noexcept override = default;;
