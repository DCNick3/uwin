...
impl FromIntoMemory for UCPTrie {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_data = <UCPTrieData as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_indexLength = <i32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_dataLength = <i32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_highStart = <i32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        let f_shifted12HighStart = <u16 as FromIntoMemory>::from_bytes(&from[20..20 + 2]);
        let f_type = <i8 as FromIntoMemory>::from_bytes(&from[22..22 + 1]);
        let f_valueWidth = <i8 as FromIntoMemory>::from_bytes(&from[23..23 + 1]);
        let f_reserved32 = <u32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_reserved16 = <u16 as FromIntoMemory>::from_bytes(&from[28..28 + 2]);
        let f_index3NullOffset = <u16 as FromIntoMemory>::from_bytes(&from[30..30 + 2]);
        let f_dataNullOffset = <i32 as FromIntoMemory>::from_bytes(&from[32..32 + 4]);
        let f_nullValue = <u32 as FromIntoMemory>::from_bytes(&from[36..36 + 4]);
        Self {
            index: f_index,
            data: f_data,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.indexLength, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.dataLength, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.highStart, &mut into[16..16 + 4]);
        FromIntoMemory::into_bytes(self.shifted12HighStart, &mut into[20..20 + 2]);
        FromIntoMemory::into_bytes(self.r#type, &mut into[22..22 + 1]);
        FromIntoMemory::into_bytes(self.valueWidth, &mut into[23..23 + 1]);
        FromIntoMemory::into_bytes(self.reserved32, &mut into[24..24 + 4]);
        FromIntoMemory::into_bytes(self.reserved16, &mut into[28..28 + 2]);
        FromIntoMemory::into_bytes(self.index3NullOffset, &mut into[30..30 + 2]);
        FromIntoMemory::into_bytes(self.dataNullOffset, &mut into[32..32 + 4]);
        FromIntoMemory::into_bytes(self.nullValue, &mut into[36..36 + 4]);
    }
    fn size() -> usize {
        40
    }
...
pub trait Api {
    #[doc = "CompareStringA from KERNEL32"]
    fn CompareStringA(
        &self,
        locale: u32,
        dw_cmp_flags: u32,
    ...
    #[doc = "ConvertDefaultLocale from KERNEL32"]
    fn ConvertDefaultLocale(&self, locale: u32) -> u32 {
        todo!("ConvertDefaultLocale")
    }
    #[doc = "EnumCalendarInfoA from KERNEL32"]
    ...
    #[doc = "EnumCalendarInfoExA from KERNEL32"]
    ...
    #[doc = "EnumCalendarInfoW from KERNEL32"]
    ...
    #[doc = "EnumDateFormatsA from KERNEL32"]
    fn EnumDateFormatsA(
        &self,
    ...
    #[doc = "EnumDateFormatsExA from KERNEL32"]
    ...
    #[doc = "EnumDateFormatsW from KERNEL32"]
    fn EnumDateFormatsW(
        &self,
    ...
    #[doc = "EnumLanguageGroupLocalesA from KERNEL32"]
    ...
    #[doc = "EnumLanguageGroupLocalesW from KERNEL32"]
    ...
    #[doc = "EnumSystemCodePagesA from KERNEL32"]
    ...
    #[doc = "EnumSystemCodePagesW from KERNEL32"]
    ...
    #[doc = "EnumSystemGeoID from KERNEL32"]
    fn EnumSystemGeoID(
        &self,
        geo_class: u32,
        parent_geo_id: i32,
    ...
    #[doc = "EnumSystemLanguageGroupsW from KERNEL32"]
    ...
    #[doc = "EnumSystemLocalesA from KERNEL32"]
    ...
    #[doc = "EnumTimeFormatsA from KERNEL32"]
    fn EnumTimeFormatsA(
        &self,
    ...
    #[doc = "EnumUILanguagesA from KERNEL32"]
    fn EnumUILanguagesA(
        &self,
    ...
    #[doc = "EnumUILanguagesW from KERNEL32"]
    fn EnumUILanguagesW(
        &self,
    ...
    #[doc = "GetACP from KERNEL32"]
    fn GetACP(&self) -> u32 {
        todo!("GetACP")
    }
    #[doc = "GetCPInfo from KERNEL32"]
    fn GetCPInfo(&self, code_page: u32, lp_cp_info: MutPtr<CPINFO>) -> super::Foundation::BOOL {
        todo!("GetCPInfo")
    }
    #[doc = "GetCPInfoExA from KERNEL32"]
    fn GetCPInfoExA(
        &self,
        code_page: u32,
        dw_flags: u32,
    ...
    #[doc = "GetCPInfoExW from KERNEL32"]
    fn GetCPInfoExW(
        &self,
        code_page: u32,
        dw_flags: u32,
    ...
    #[doc = "GetCalendarInfoA from KERNEL32"]
    fn GetCalendarInfoA(
        &self,
        locale: u32,
        calendar: u32,
    ...
    #[doc = "GetCurrencyFormatA from KERNEL32"]
    ...
    #[doc = "GetCurrencyFormatEx from KERNEL32"]
    ...
    #[doc = "GetCurrencyFormatW from KERNEL32"]
    ...
    #[doc = "GetDateFormatA from KERNEL32"]
    fn GetDateFormatA(
        &self,
        locale: u32,
        dw_flags: u32,
    ...
    #[doc = "GetLocaleInfoA from KERNEL32"]
    ...
    #[doc = "GetStringTypeExA from KERNEL32"]
    fn GetStringTypeExA(
        &self,
        locale: u32,
        dw_info_type: u32,
    ...
    #[doc = "GetStringTypeExW from KERNEL32"]
    fn GetStringTypeExW(
        &self,
        locale: u32,
        dw_info_type: u32,
    ...
    #[doc = "GetStringTypeW from KERNEL32"]
    fn GetStringTypeW(
        &self,
        dw_info_type: u32,
        lp_src_str: PCWSTR,
    ...
    #[doc = "GetSystemDefaultLCID from KERNEL32"]
    fn GetSystemDefaultLCID(&self) -> u32 {
        todo!("GetSystemDefaultLCID")
    }
    #[doc = "GetSystemDefaultLangID from KERNEL32"]
    ...
    #[doc = "GetTextCharsetInfo from GDI32"]
    ...
    #[doc = "GetThreadLocale from KERNEL32"]
    ...
    #[doc = "GetUserGeoID from KERNEL32"]
    ...
    #[doc = "IsValidLocale from KERNEL32"]
    fn IsValidLocale(
        &self,
        locale: u32,
    ...
    #[doc = "SetCalendarInfoA from KERNEL32"]
    fn SetCalendarInfoA(
        &self,
        locale: u32,
        calendar: u32,
    ...
    #[doc = "SetCalendarInfoW from KERNEL32"]
    fn SetCalendarInfoW(
        &self,
        locale: u32,
        calendar: u32,
    ...
    #[doc = "SetLocaleInfoA from KERNEL32"]
    fn SetLocaleInfoA(
        &self,
        locale: u32,
        lc_type: u32,
    ...
    #[doc = "SetLocaleInfoW from KERNEL32"]
    fn SetLocaleInfoW(
        &self,
        locale: u32,
        lc_type: u32,
    ...
    #[doc = "SetThreadUILanguage from KERNEL32"]
    fn SetThreadUILanguage(&self, lang_id: u16) -> u16 {
        todo!("SetThreadUILanguage")
    }
    #[doc = "SetUserGeoID from KERNEL32"]
