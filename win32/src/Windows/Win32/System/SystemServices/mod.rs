...
impl FromIntoMemory for GDI_NONREMOTE {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_u = <GDI_NONREMOTE_0 as FromIntoMemory>::from_bytes(&from[4..4 + 8]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.u, &mut into[4..4 + 8]);
    }
    fn size() -> usize {
        12u32 as usize
    }
...
pub struct GDI_NONREMOTE_0 {
    pub hInproc: i32,
    pub hRemote: MutPtr<super::Com::DWORD_BLOB>,
}
#[doc = "*Required namespaces: 'Windows.Win32.System.Com'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl ::core::cmp::PartialEq for GDI_NONREMOTE_0 {
    fn eq(&self, other: &Self) -> bool {
        self.hInproc == other.hInproc && self.hRemote == other.hRemote
    }
}
#[doc = "*Required namespaces: 'Windows.Win32.System.Com'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl FromIntoMemory for IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 40u32 as usize);
        let f_BeginAddress = <u64 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_EndAddress = <u64 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        let f_ExceptionHandler = <u64 as FromIntoMemory>::from_bytes(&from[16..16 + 8]);
        let f_HandlerData = <u64 as FromIntoMemory>::from_bytes(&from[24..24 + 8]);
        let f_PrologEndAddress = <u64 as FromIntoMemory>::from_bytes(&from[32..32 + 8]);
        Self {
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.BeginAddress, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.EndAddress, &mut into[8..8 + 8]);
        FromIntoMemory::into_bytes(self.ExceptionHandler, &mut into[16..16 + 8]);
        FromIntoMemory::into_bytes(self.HandlerData, &mut into[24..24 + 8]);
        FromIntoMemory::into_bytes(self.PrologEndAddress, &mut into[32..32 + 8]);
    }
    fn size() -> usize {
        40u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_XDATA {
    fn eq(&self, other: &Self) -> bool {
        self.HeaderData == other.HeaderData && self.Anonymous == other.Anonymous
    }
}
...
impl FromIntoMemory for IMAGE_ARM_RUNTIME_FUNCTION_ENTRY {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_BeginAddress = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_Anonymous =
            <IMAGE_ARM_RUNTIME_FUNCTION_ENTRY_0 as FromIntoMemory>::from_bytes(&from[4..4 + 8]);
        Self {
            BeginAddress: f_BeginAddress,
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL {
    fn eq(&self, other: &Self) -> bool {
        self.Sym == other.Sym
            ...
            && self.TokenDef == other.TokenDef
            && self.CRC == other.CRC
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_0 {
    fn eq(&self, other: &Self) -> bool {
        self.crc == other.crc && self.rgbReserved == other.rgbReserved
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_0 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_crc = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_rgbReserved = <[u8; 14] as FromIntoMemory>::from_bytes(&from[4..4 + 14]);
        Self {
            crc: f_crc,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.crc, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.rgbReserved, &mut into[4..4 + 14]);
    }
    fn size() -> usize {
        20u32 as usize
    }
...
impl ::core::fmt::Debug for IMAGE_AUX_SYMBOL_1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_AUX_SYMBOL_1")
            .field("Name", &self.Name)
            .finish()
    }
}
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_1 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 18u32 as usize);
        let f_Name = <[u8; 18] as FromIntoMemory>::from_bytes(&from[0..0 + 18]);
        Self { Name: f_Name }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 18u32 as usize);
        FromIntoMemory::into_bytes(self.Name, &mut into[0..0 + 18]);
    }
    fn size() -> usize {
        18u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_2 {
    fn eq(&self, other: &Self) -> bool {
        self.Length == other.Length
            ...
            && self.HighNumber == other.HighNumber
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_2 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_2 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_Length = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_NumberOfRelocations = <u16 as FromIntoMemory>::from_bytes(&from[4..4 + 2]);
        let f_NumberOfLinenumbers = <u16 as FromIntoMemory>::from_bytes(&from[6..6 + 2]);
        let f_CheckSum = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_Number = <i16 as FromIntoMemory>::from_bytes(&from[12..12 + 2]);
        let f_Selection = <u8 as FromIntoMemory>::from_bytes(&from[14..14 + 1]);
        let f_bReserved = <u8 as FromIntoMemory>::from_bytes(&from[15..15 + 1]);
        let f_HighNumber = <i16 as FromIntoMemory>::from_bytes(&from[16..16 + 2]);
        Self {
            Length: f_Length,
            ...
            bReserved: f_bReserved,
            HighNumber: f_HighNumber,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.Length, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.NumberOfRelocations, &mut into[4..4 + 2]);
        FromIntoMemory::into_bytes(self.NumberOfLinenumbers, &mut into[6..6 + 2]);
        FromIntoMemory::into_bytes(self.CheckSum, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.Number, &mut into[12..12 + 2]);
        FromIntoMemory::into_bytes(self.Selection, &mut into[14..14 + 1]);
        FromIntoMemory::into_bytes(self.bReserved, &mut into[15..15 + 1]);
        FromIntoMemory::into_bytes(self.HighNumber, &mut into[16..16 + 2]);
    }
    fn size() -> usize {
        20u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_3 {
    fn eq(&self, other: &Self) -> bool {
        self.TagIndex == other.TagIndex
            && self.Misc == other.Misc
            && self.FcnAry == other.FcnAry
            && self.TvIndex == other.TvIndex
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_3 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_3 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 32u32 as usize);
        let f_TagIndex = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_Misc = <IMAGE_AUX_SYMBOL_3_1 as FromIntoMemory>::from_bytes(&from[4..4 + 8]);
        let f_FcnAry = <IMAGE_AUX_SYMBOL_3_0 as FromIntoMemory>::from_bytes(&from[12..12 + 16]);
        let f_TvIndex = <u16 as FromIntoMemory>::from_bytes(&from[28..28 + 2]);
        Self {
            TagIndex: f_TagIndex,
            Misc: f_Misc,
            FcnAry: f_FcnAry,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 32u32 as usize);
        FromIntoMemory::into_bytes(self.TagIndex, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.Misc, &mut into[4..4 + 8]);
        FromIntoMemory::into_bytes(self.FcnAry, &mut into[12..12 + 16]);
        FromIntoMemory::into_bytes(self.TvIndex, &mut into[28..28 + 2]);
    }
    fn size() -> usize {
        32u32 as usize
    }
}
pub struct IMAGE_AUX_SYMBOL_3_0 {
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_3_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Function == other.Function && self.Array == other.Array
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_3_0 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_3_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for IMAGE_AUX_SYMBOL_3_0_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_AUX_SYMBOL_3_0_0")
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_3_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_Dimension = <[u16; 4] as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        Self {
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 8u32 as usize);
        FromIntoMemory::into_bytes(self.Dimension, &mut into[0..0 + 8]);
    }
    fn size() -> usize {
        8u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_3_0_1 {
    fn eq(&self, other: &Self) -> bool {
        self.PointerToLinenumber == other.PointerToLinenumber
            && self.PointerToNextFunction == other.PointerToNextFunction
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_3_0_1 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_3_0_1 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_PointerToLinenumber = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_PointerToNextFunction = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        Self {
            PointerToLinenumber: f_PointerToLinenumber,
            PointerToNextFunction: f_PointerToNextFunction,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 8u32 as usize);
        FromIntoMemory::into_bytes(self.PointerToLinenumber, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.PointerToNextFunction, &mut into[4..4 + 4]);
    }
    fn size() -> usize {
        8u32 as usize
    }
}
pub struct IMAGE_AUX_SYMBOL_3_1 {
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_3_1 {
    fn eq(&self, other: &Self) -> bool {
        self.LnSz == other.LnSz && self.TotalSize == other.TotalSize
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_3_1 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_3_1 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for IMAGE_AUX_SYMBOL_3_1_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_AUX_SYMBOL_3_1_0")
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_3_1_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 4u32 as usize);
        let f_Linenumber = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 4u32 as usize);
        FromIntoMemory::into_bytes(self.Linenumber, &mut into[0..0 + 2]);
...
pub struct IMAGE_AUX_SYMBOL_EX {
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_EX {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_EX_0 {
    fn eq(&self, other: &Self) -> bool {
        self.TokenDef == other.TokenDef && self.rgbReserved == other.rgbReserved
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_EX_0 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_EX_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_TokenDef =
            <IMAGE_AUX_SYMBOL_TOKEN_DEF as FromIntoMemory>::from_bytes(&from[0..0 + 20]);
        let f_rgbReserved = <[u8; 2] as FromIntoMemory>::from_bytes(&from[20..20 + 2]);
        Self {
            TokenDef: f_TokenDef,
            rgbReserved: f_rgbReserved,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 24u32 as usize);
        FromIntoMemory::into_bytes(self.TokenDef, &mut into[0..0 + 20]);
        FromIntoMemory::into_bytes(self.rgbReserved, &mut into[20..20 + 2]);
    }
    fn size() -> usize {
        24u32 as usize
    }
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_EX_1 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_crc = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_rgbReserved = <[u8; 16] as FromIntoMemory>::from_bytes(&from[4..4 + 16]);
        Self {
            crc: f_crc,
            rgbReserved: f_rgbReserved,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.crc, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.rgbReserved, &mut into[4..4 + 16]);
    }
    fn size() -> usize {
        20u32 as usize
    }
...
impl ::core::fmt::Debug for IMAGE_AUX_SYMBOL_EX_2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_AUX_SYMBOL_EX_2")
            .field("Name", &self.Name)
            .finish()
    }
}
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_EX_2 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_Name = <[u8; 20] as FromIntoMemory>::from_bytes(&from[0..0 + 20]);
        Self { Name: f_Name }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.Name, &mut into[0..0 + 20]);
    }
    fn size() -> usize {
        20u32 as usize
    }
...
impl FromIntoMemory for IMAGE_AUX_SYMBOL_EX_3 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_Length = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_NumberOfRelocations = <u16 as FromIntoMemory>::from_bytes(&from[4..4 + 2]);
        ...
        let f_bReserved = <u8 as FromIntoMemory>::from_bytes(&from[15..15 + 1]);
        let f_HighNumber = <i16 as FromIntoMemory>::from_bytes(&from[16..16 + 2]);
        let f_rgbReserved = <[u8; 2] as FromIntoMemory>::from_bytes(&from[18..18 + 2]);
        Self {
            Length: f_Length,
            NumberOfRelocations: f_NumberOfRelocations,
            NumberOfLinenumbers: f_NumberOfLinenumbers,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.bReserved, &mut into[15..15 + 1]);
        FromIntoMemory::into_bytes(self.HighNumber, &mut into[16..16 + 2]);
        FromIntoMemory::into_bytes(self.rgbReserved, &mut into[18..18 + 2]);
    }
    fn size() -> usize {
        20u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_EX_4 {
    fn eq(&self, other: &Self) -> bool {
        self.WeakDefaultSymIndex == other.WeakDefaultSymIndex
            && self.WeakSearchType == other.WeakSearchType
            && self.rgbReserved == other.rgbReserved
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_EX_4 {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_EX_4 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_WeakDefaultSymIndex = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_WeakSearchType = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_rgbReserved = <[u8; 12] as FromIntoMemory>::from_bytes(&from[8..8 + 12]);
        Self {
            WeakDefaultSymIndex: f_WeakDefaultSymIndex,
            WeakSearchType: f_WeakSearchType,
            rgbReserved: f_rgbReserved,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.WeakDefaultSymIndex, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.WeakSearchType, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.rgbReserved, &mut into[8..8 + 12]);
    }
    fn size() -> usize {
        20u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_AUX_SYMBOL_TOKEN_DEF {
    fn eq(&self, other: &Self) -> bool {
        self.bAuxType == other.bAuxType
            && self.bReserved == other.bReserved
            && self.SymbolTableIndex == other.SymbolTableIndex
            && self.rgbReserved == other.rgbReserved
    }
}
impl ::core::cmp::Eq for IMAGE_AUX_SYMBOL_TOKEN_DEF {}
impl FromIntoMemory for IMAGE_AUX_SYMBOL_TOKEN_DEF {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_bAuxType = <u8 as FromIntoMemory>::from_bytes(&from[0..0 + 1]);
        let f_bReserved = <u8 as FromIntoMemory>::from_bytes(&from[1..1 + 1]);
        let f_SymbolTableIndex = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_rgbReserved = <[u8; 12] as FromIntoMemory>::from_bytes(&from[8..8 + 12]);
        Self {
            bAuxType: f_bAuxType,
            bReserved: f_bReserved,
            SymbolTableIndex: f_SymbolTableIndex,
            rgbReserved: f_rgbReserved,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.bAuxType, &mut into[0..0 + 1]);
        FromIntoMemory::into_bytes(self.bReserved, &mut into[1..1 + 1]);
        FromIntoMemory::into_bytes(self.SymbolTableIndex, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.rgbReserved, &mut into[8..8 + 12]);
    }
    fn size() -> usize {
        20u32 as usize
...
impl ::core::cmp::PartialEq for IMAGE_DOS_HEADER {
    fn eq(&self, other: &Self) -> bool {
        self.e_magic == other.e_magic
            && self.e_cblp == other.e_cblp
            && self.e_cp == other.e_cp
            && self.e_crlc == other.e_crlc
            && self.e_cparhdr == other.e_cparhdr
            && self.e_minalloc == other.e_minalloc
            && self.e_maxalloc == other.e_maxalloc
            && self.e_ss == other.e_ss
            && self.e_sp == other.e_sp
            && self.e_csum == other.e_csum
            && self.e_ip == other.e_ip
            && self.e_cs == other.e_cs
            && self.e_lfarlc == other.e_lfarlc
            && self.e_ovno == other.e_ovno
            && self.e_res == other.e_res
            && self.e_oemid == other.e_oemid
            && self.e_oeminfo == other.e_oeminfo
            && self.e_res2 == other.e_res2
            && self.e_lfanew == other.e_lfanew
    }
}
impl ::core::cmp::Eq for IMAGE_DOS_HEADER {}
impl FromIntoMemory for IMAGE_DOS_HEADER {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 64u32 as usize);
        let f_e_magic = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        let f_e_cblp = <u16 as FromIntoMemory>::from_bytes(&from[2..2 + 2]);
        let f_e_cp = <u16 as FromIntoMemory>::from_bytes(&from[4..4 + 2]);
        let f_e_crlc = <u16 as FromIntoMemory>::from_bytes(&from[6..6 + 2]);
        let f_e_cparhdr = <u16 as FromIntoMemory>::from_bytes(&from[8..8 + 2]);
        let f_e_minalloc = <u16 as FromIntoMemory>::from_bytes(&from[10..10 + 2]);
        let f_e_maxalloc = <u16 as FromIntoMemory>::from_bytes(&from[12..12 + 2]);
        let f_e_ss = <u16 as FromIntoMemory>::from_bytes(&from[14..14 + 2]);
        let f_e_sp = <u16 as FromIntoMemory>::from_bytes(&from[16..16 + 2]);
        let f_e_csum = <u16 as FromIntoMemory>::from_bytes(&from[18..18 + 2]);
        let f_e_ip = <u16 as FromIntoMemory>::from_bytes(&from[20..20 + 2]);
        let f_e_cs = <u16 as FromIntoMemory>::from_bytes(&from[22..22 + 2]);
        let f_e_lfarlc = <u16 as FromIntoMemory>::from_bytes(&from[24..24 + 2]);
        let f_e_ovno = <u16 as FromIntoMemory>::from_bytes(&from[26..26 + 2]);
        let f_e_res = <[u16; 4] as FromIntoMemory>::from_bytes(&from[28..28 + 8]);
        let f_e_oemid = <u16 as FromIntoMemory>::from_bytes(&from[36..36 + 2]);
        let f_e_oeminfo = <u16 as FromIntoMemory>::from_bytes(&from[38..38 + 2]);
        let f_e_res2 = <[u16; 10] as FromIntoMemory>::from_bytes(&from[40..40 + 20]);
        let f_e_lfanew = <i32 as FromIntoMemory>::from_bytes(&from[60..60 + 4]);
        Self {
            e_magic: f_e_magic,
            e_cblp: f_e_cblp,
            e_cp: f_e_cp,
            e_crlc: f_e_crlc,
            e_cparhdr: f_e_cparhdr,
            e_minalloc: f_e_minalloc,
            e_maxalloc: f_e_maxalloc,
            e_ss: f_e_ss,
            e_sp: f_e_sp,
            e_csum: f_e_csum,
            e_ip: f_e_ip,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.e_magic, &mut into[0..0 + 2]);
        FromIntoMemory::into_bytes(self.e_cblp, &mut into[2..2 + 2]);
        FromIntoMemory::into_bytes(self.e_cp, &mut into[4..4 + 2]);
        FromIntoMemory::into_bytes(self.e_crlc, &mut into[6..6 + 2]);
        FromIntoMemory::into_bytes(self.e_cparhdr, &mut into[8..8 + 2]);
        FromIntoMemory::into_bytes(self.e_minalloc, &mut into[10..10 + 2]);
        FromIntoMemory::into_bytes(self.e_maxalloc, &mut into[12..12 + 2]);
        FromIntoMemory::into_bytes(self.e_ss, &mut into[14..14 + 2]);
        FromIntoMemory::into_bytes(self.e_sp, &mut into[16..16 + 2]);
        FromIntoMemory::into_bytes(self.e_csum, &mut into[18..18 + 2]);
        FromIntoMemory::into_bytes(self.e_ip, &mut into[20..20 + 2]);
        FromIntoMemory::into_bytes(self.e_cs, &mut into[22..22 + 2]);
        FromIntoMemory::into_bytes(self.e_lfarlc, &mut into[24..24 + 2]);
        FromIntoMemory::into_bytes(self.e_ovno, &mut into[26..26 + 2]);
        FromIntoMemory::into_bytes(self.e_res, &mut into[28..28 + 8]);
        FromIntoMemory::into_bytes(self.e_oemid, &mut into[36..36 + 2]);
        FromIntoMemory::into_bytes(self.e_oeminfo, &mut into[38..38 + 2]);
        FromIntoMemory::into_bytes(self.e_res2, &mut into[40..40 + 20]);
        FromIntoMemory::into_bytes(self.e_lfanew, &mut into[60..60 + 4]);
    }
    fn size() -> usize {
        64u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_DYNAMIC_RELOCATION32 {
    fn eq(&self, other: &Self) -> bool {
        self.Symbol == other.Symbol && self.BaseRelocSize == other.BaseRelocSize
    }
}
impl ::core::cmp::Eq for IMAGE_DYNAMIC_RELOCATION32 {}
impl FromIntoMemory for IMAGE_DYNAMIC_RELOCATION32 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_Symbol = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_BaseRelocSize = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        Self {
            Symbol: f_Symbol,
            BaseRelocSize: f_BaseRelocSize,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 8u32 as usize);
        FromIntoMemory::into_bytes(self.Symbol, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.BaseRelocSize, &mut into[4..4 + 4]);
    }
    fn size() -> usize {
        8u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_DYNAMIC_RELOCATION32_V2 {
    fn eq(&self, other: &Self) -> bool {
        self.HeaderSize == other.HeaderSize
            && self.FixupInfoSize == other.FixupInfoSize
            && self.Symbol == other.Symbol
            && self.SymbolGroup == other.SymbolGroup
            && self.Flags == other.Flags
    }
}
impl ::core::cmp::Eq for IMAGE_DYNAMIC_RELOCATION32_V2 {}
impl FromIntoMemory for IMAGE_DYNAMIC_RELOCATION32_V2 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_HeaderSize = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_FixupInfoSize = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_Symbol = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_SymbolGroup = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_Flags = <u32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        Self {
            HeaderSize: f_HeaderSize,
            FixupInfoSize: f_FixupInfoSize,
            Symbol: f_Symbol,
            SymbolGroup: f_SymbolGroup,
            Flags: f_Flags,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.HeaderSize, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.FixupInfoSize, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.Symbol, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.SymbolGroup, &mut into[12..12 + 4]);
...
impl FromIntoMemory for IMAGE_DYNAMIC_RELOCATION64 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 16u32 as usize);
        let f_Symbol = <u64 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_BaseRelocSize = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        Self {
            Symbol: f_Symbol,
            BaseRelocSize: f_BaseRelocSize,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 16u32 as usize);
        FromIntoMemory::into_bytes(self.Symbol, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.BaseRelocSize, &mut into[8..8 + 4]);
    }
    fn size() -> usize {
        16u32 as usize
    }
...
impl FromIntoMemory for IMAGE_DYNAMIC_RELOCATION64_V2 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_HeaderSize = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_FixupInfoSize = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_Symbol = <u64 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        let f_SymbolGroup = <u32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.HeaderSize, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.FixupInfoSize, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.Symbol, &mut into[8..8 + 8]);
        FromIntoMemory::into_bytes(self.SymbolGroup, &mut into[16..16 + 4]);
...
impl ::core::cmp::PartialEq for IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {
    fn eq(&self, other: &Self) -> bool {
        self.EpilogueCount == other.EpilogueCount
            && self.EpilogueByteCount == other.EpilogueByteCount
            && self.BranchDescriptorElementSize == other.BranchDescriptorElementSize
            && self.BranchDescriptorCount == other.BranchDescriptorCount
    }
}
impl ::core::cmp::Eq for IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {}
impl FromIntoMemory for IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_EpilogueCount = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_EpilogueByteCount = <u8 as FromIntoMemory>::from_bytes(&from[4..4 + 1]);
        let f_BranchDescriptorElementSize = <u8 as FromIntoMemory>::from_bytes(&from[5..5 + 1]);
        let f_BranchDescriptorCount = <u16 as FromIntoMemory>::from_bytes(&from[6..6 + 2]);
        Self {
            EpilogueCount: f_EpilogueCount,
            EpilogueByteCount: f_EpilogueByteCount,
            BranchDescriptorElementSize: f_BranchDescriptorElementSize,
            BranchDescriptorCount: f_BranchDescriptorCount,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 8u32 as usize);
        FromIntoMemory::into_bytes(self.EpilogueCount, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.EpilogueByteCount, &mut into[4..4 + 1]);
        FromIntoMemory::into_bytes(self.BranchDescriptorElementSize, &mut into[5..5 + 1]);
        FromIntoMemory::into_bytes(self.BranchDescriptorCount, &mut into[6..6 + 2]);
    }
    fn size() -> usize {
        8u32 as usize
    }
...
impl FromIntoMemory for IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 4u32 as usize);
        let f__bitfield = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        Self {
...
impl ::core::cmp::PartialEq for IMAGE_IMPORT_DESCRIPTOR {
    fn eq(&self, other: &Self) -> bool {
        self.Anonymous == other.Anonymous
            && self.TimeDateStamp == other.TimeDateStamp
            && self.ForwarderChain == other.ForwarderChain
            && self.Name == other.Name
            && self.FirstThunk == other.FirstThunk
    }
}
impl ::core::cmp::Eq for IMAGE_IMPORT_DESCRIPTOR {}
impl FromIntoMemory for IMAGE_IMPORT_DESCRIPTOR {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_Anonymous =
            <IMAGE_IMPORT_DESCRIPTOR_0 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_TimeDateStamp = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_ForwarderChain = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_Name = <u32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        let f_FirstThunk = <u32 as FromIntoMemory>::from_bytes(&from[20..20 + 4]);
        Self {
            Anonymous: f_Anonymous,
            TimeDateStamp: f_TimeDateStamp,
            ForwarderChain: f_ForwarderChain,
            Name: f_Name,
            FirstThunk: f_FirstThunk,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 24u32 as usize);
        ...
        FromIntoMemory::into_bytes(self.TimeDateStamp, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.ForwarderChain, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.Name, &mut into[16..16 + 4]);
        FromIntoMemory::into_bytes(self.FirstThunk, &mut into[20..20 + 4]);
    }
    fn size() -> usize {
        24u32 as usize
    }
}
pub struct IMAGE_IMPORT_DESCRIPTOR_0 {
    pub Characteristics: u32,
...
impl ::core::cmp::PartialEq for IMAGE_IMPORT_DESCRIPTOR_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Characteristics == other.Characteristics
            && self.OriginalFirstThunk == other.OriginalFirstThunk
    }
}
impl ::core::cmp::Eq for IMAGE_IMPORT_DESCRIPTOR_0 {}
impl FromIntoMemory for IMAGE_IMPORT_DESCRIPTOR_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION {
    fn from_bytes(from: &[u8]) -> Self {
...
impl ::core::cmp::PartialEq for IMAGE_LINENUMBER {
    fn eq(&self, other: &Self) -> bool {
        self.Type == other.Type && self.Linenumber == other.Linenumber
    }
}
impl ::core::cmp::Eq for IMAGE_LINENUMBER {}
impl FromIntoMemory for IMAGE_LINENUMBER {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 12u32 as usize);
        let f_Type = <IMAGE_LINENUMBER_0 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_Linenumber = <u16 as FromIntoMemory>::from_bytes(&from[8..8 + 2]);
        Self {
            Type: f_Type,
            Linenumber: f_Linenumber,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 12u32 as usize);
        FromIntoMemory::into_bytes(self.Type, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.Linenumber, &mut into[8..8 + 2]);
    }
    fn size() -> usize {
        12u32 as usize
    }
}
pub struct IMAGE_LINENUMBER_0 {
    pub SymbolTableIndex: u32,
    pub VirtualAddress: u32,
}
...
impl FromIntoMemory for IMAGE_LINENUMBER_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::cmp::PartialEq for IMAGE_OS2_HEADER {
    fn eq(&self, other: &Self) -> bool {
        self.ne_magic == other.ne_magic
            && self.ne_ver == other.ne_ver
            && self.ne_rev == other.ne_rev
            && self.ne_enttab == other.ne_enttab
            && self.ne_cbenttab == other.ne_cbenttab
            && self.ne_crc == other.ne_crc
            && self.ne_flags == other.ne_flags
            && self.ne_autodata == other.ne_autodata
            && self.ne_heap == other.ne_heap
            && self.ne_stack == other.ne_stack
            && self.ne_csip == other.ne_csip
            && self.ne_sssp == other.ne_sssp
            && self.ne_cseg == other.ne_cseg
            && self.ne_cmod == other.ne_cmod
            && self.ne_cbnrestab == other.ne_cbnrestab
            && self.ne_segtab == other.ne_segtab
            && self.ne_rsrctab == other.ne_rsrctab
            && self.ne_restab == other.ne_restab
            && self.ne_modtab == other.ne_modtab
            && self.ne_imptab == other.ne_imptab
            && self.ne_nrestab == other.ne_nrestab
            && self.ne_cmovent == other.ne_cmovent
            && self.ne_align == other.ne_align
            && self.ne_cres == other.ne_cres
            && self.ne_exetyp == other.ne_exetyp
            && self.ne_flagsothers == other.ne_flagsothers
            && self.ne_pretthunks == other.ne_pretthunks
            && self.ne_psegrefbytes == other.ne_psegrefbytes
            && self.ne_swaparea == other.ne_swaparea
            && self.ne_expver == other.ne_expver
    }
}
impl ::core::cmp::Eq for IMAGE_OS2_HEADER {}
impl FromIntoMemory for IMAGE_OS2_HEADER {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 64u32 as usize);
        let f_ne_magic = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        let f_ne_ver =
            <super::super::Foundation::CHAR as FromIntoMemory>::from_bytes(&from[2..2 + 1]);
        let f_ne_rev =
            <super::super::Foundation::CHAR as FromIntoMemory>::from_bytes(&from[3..3 + 1]);
        let f_ne_enttab = <u16 as FromIntoMemory>::from_bytes(&from[4..4 + 2]);
        let f_ne_cbenttab = <u16 as FromIntoMemory>::from_bytes(&from[6..6 + 2]);
        let f_ne_crc = <i32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_ne_flags = <u16 as FromIntoMemory>::from_bytes(&from[12..12 + 2]);
        let f_ne_autodata = <u16 as FromIntoMemory>::from_bytes(&from[14..14 + 2]);
        let f_ne_heap = <u16 as FromIntoMemory>::from_bytes(&from[16..16 + 2]);
        let f_ne_stack = <u16 as FromIntoMemory>::from_bytes(&from[18..18 + 2]);
        let f_ne_csip = <i32 as FromIntoMemory>::from_bytes(&from[20..20 + 4]);
        let f_ne_sssp = <i32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_ne_cseg = <u16 as FromIntoMemory>::from_bytes(&from[28..28 + 2]);
        let f_ne_cmod = <u16 as FromIntoMemory>::from_bytes(&from[30..30 + 2]);
        let f_ne_cbnrestab = <u16 as FromIntoMemory>::from_bytes(&from[32..32 + 2]);
        let f_ne_segtab = <u16 as FromIntoMemory>::from_bytes(&from[34..34 + 2]);
        let f_ne_rsrctab = <u16 as FromIntoMemory>::from_bytes(&from[36..36 + 2]);
        let f_ne_restab = <u16 as FromIntoMemory>::from_bytes(&from[38..38 + 2]);
        let f_ne_modtab = <u16 as FromIntoMemory>::from_bytes(&from[40..40 + 2]);
        let f_ne_imptab = <u16 as FromIntoMemory>::from_bytes(&from[42..42 + 2]);
        let f_ne_nrestab = <i32 as FromIntoMemory>::from_bytes(&from[44..44 + 4]);
        let f_ne_cmovent = <u16 as FromIntoMemory>::from_bytes(&from[48..48 + 2]);
        let f_ne_align = <u16 as FromIntoMemory>::from_bytes(&from[50..50 + 2]);
        let f_ne_cres = <u16 as FromIntoMemory>::from_bytes(&from[52..52 + 2]);
        let f_ne_exetyp = <u8 as FromIntoMemory>::from_bytes(&from[54..54 + 1]);
        let f_ne_flagsothers = <u8 as FromIntoMemory>::from_bytes(&from[55..55 + 1]);
        let f_ne_pretthunks = <u16 as FromIntoMemory>::from_bytes(&from[56..56 + 2]);
        let f_ne_psegrefbytes = <u16 as FromIntoMemory>::from_bytes(&from[58..58 + 2]);
        let f_ne_swaparea = <u16 as FromIntoMemory>::from_bytes(&from[60..60 + 2]);
        let f_ne_expver = <u16 as FromIntoMemory>::from_bytes(&from[62..62 + 2]);
        Self {
            ne_magic: f_ne_magic,
            ne_ver: f_ne_ver,
            ne_rev: f_ne_rev,
            ne_enttab: f_ne_enttab,
            ne_cbenttab: f_ne_cbenttab,
            ne_crc: f_ne_crc,
            ne_flags: f_ne_flags,
            ne_autodata: f_ne_autodata,
            ne_heap: f_ne_heap,
            ne_stack: f_ne_stack,
            ne_csip: f_ne_csip,
            ne_sssp: f_ne_sssp,
            ne_cseg: f_ne_cseg,
            ne_cmod: f_ne_cmod,
            ne_cbnrestab: f_ne_cbnrestab,
            ne_segtab: f_ne_segtab,
            ne_rsrctab: f_ne_rsrctab,
            ne_restab: f_ne_restab,
            ne_modtab: f_ne_modtab,
            ne_imptab: f_ne_imptab,
            ne_nrestab: f_ne_nrestab,
            ne_cmovent: f_ne_cmovent,
            ne_align: f_ne_align,
            ne_cres: f_ne_cres,
            ne_exetyp: f_ne_exetyp,
            ne_flagsothers: f_ne_flagsothers,
            ne_pretthunks: f_ne_pretthunks,
            ne_psegrefbytes: f_ne_psegrefbytes,
            ne_swaparea: f_ne_swaparea,
            ne_expver: f_ne_expver,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 64u32 as usize);
        FromIntoMemory::into_bytes(self.ne_magic, &mut into[0..0 + 2]);
        FromIntoMemory::into_bytes(self.ne_ver, &mut into[2..2 + 1]);
        FromIntoMemory::into_bytes(self.ne_rev, &mut into[3..3 + 1]);
        FromIntoMemory::into_bytes(self.ne_enttab, &mut into[4..4 + 2]);
        FromIntoMemory::into_bytes(self.ne_cbenttab, &mut into[6..6 + 2]);
        FromIntoMemory::into_bytes(self.ne_crc, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.ne_flags, &mut into[12..12 + 2]);
        FromIntoMemory::into_bytes(self.ne_autodata, &mut into[14..14 + 2]);
        FromIntoMemory::into_bytes(self.ne_heap, &mut into[16..16 + 2]);
        FromIntoMemory::into_bytes(self.ne_stack, &mut into[18..18 + 2]);
        FromIntoMemory::into_bytes(self.ne_csip, &mut into[20..20 + 4]);
        FromIntoMemory::into_bytes(self.ne_sssp, &mut into[24..24 + 4]);
        FromIntoMemory::into_bytes(self.ne_cseg, &mut into[28..28 + 2]);
        FromIntoMemory::into_bytes(self.ne_cmod, &mut into[30..30 + 2]);
        FromIntoMemory::into_bytes(self.ne_cbnrestab, &mut into[32..32 + 2]);
        FromIntoMemory::into_bytes(self.ne_segtab, &mut into[34..34 + 2]);
        FromIntoMemory::into_bytes(self.ne_rsrctab, &mut into[36..36 + 2]);
        FromIntoMemory::into_bytes(self.ne_restab, &mut into[38..38 + 2]);
        FromIntoMemory::into_bytes(self.ne_modtab, &mut into[40..40 + 2]);
        FromIntoMemory::into_bytes(self.ne_imptab, &mut into[42..42 + 2]);
        FromIntoMemory::into_bytes(self.ne_nrestab, &mut into[44..44 + 4]);
        FromIntoMemory::into_bytes(self.ne_cmovent, &mut into[48..48 + 2]);
        FromIntoMemory::into_bytes(self.ne_align, &mut into[50..50 + 2]);
        FromIntoMemory::into_bytes(self.ne_cres, &mut into[52..52 + 2]);
        FromIntoMemory::into_bytes(self.ne_exetyp, &mut into[54..54 + 1]);
        FromIntoMemory::into_bytes(self.ne_flagsothers, &mut into[55..55 + 1]);
        FromIntoMemory::into_bytes(self.ne_pretthunks, &mut into[56..56 + 2]);
        FromIntoMemory::into_bytes(self.ne_psegrefbytes, &mut into[58..58 + 2]);
        FromIntoMemory::into_bytes(self.ne_swaparea, &mut into[60..60 + 2]);
        FromIntoMemory::into_bytes(self.ne_expver, &mut into[62..62 + 2]);
    }
    fn size() -> usize {
        64u32 as usize
    }
...
impl ::core::cmp::PartialEq for IMAGE_POLICY_ENTRY {
    fn eq(&self, other: &Self) -> bool {
        self.Type == other.Type && self.PolicyId == other.PolicyId && self.u == other.u
    }
}
impl ::core::cmp::Eq for IMAGE_POLICY_ENTRY {}
impl FromIntoMemory for IMAGE_POLICY_ENTRY {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 56u32 as usize);
        let f_Type = <IMAGE_POLICY_ENTRY_TYPE as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_PolicyId = <IMAGE_POLICY_ID as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_u = <IMAGE_POLICY_ENTRY_0 as FromIntoMemory>::from_bytes(&from[8..8 + 48]);
        Self {
            Type: f_Type,
            PolicyId: f_PolicyId,
            u: f_u,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.PolicyId, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.u, &mut into[8..8 + 48]);
    }
    fn size() -> usize {
        56u32 as usize
    }
}
pub struct IMAGE_POLICY_ENTRY_0 {
    pub None: ConstPtr<::core::ffi::c_void>,
...
impl ::core::cmp::PartialEq for IMAGE_POLICY_ENTRY_0 {
    fn eq(&self, other: &Self) -> bool {
        self.None == other.None
            ...
            && self.Int8Value == other.Int8Value
            && self.UInt8Value == other.UInt8Value
            && self.Int16Value == other.Int16Value
            && self.UInt16Value == other.UInt16Value
            ...
            && self.AnsiStringValue == other.AnsiStringValue
            && self.UnicodeStringValue == other.UnicodeStringValue
    }
}
impl ::core::cmp::Eq for IMAGE_POLICY_ENTRY_0 {}
impl FromIntoMemory for IMAGE_POLICY_ENTRY_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for IMAGE_POLICY_METADATA {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 72u32 as usize);
        let f_Version = <u8 as FromIntoMemory>::from_bytes(&from[0..0 + 1]);
        let f_Reserved0 = <[u8; 7] as FromIntoMemory>::from_bytes(&from[1..1 + 7]);
        let f_ApplicationId = <u64 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        let f_Policies =
            <[IMAGE_POLICY_ENTRY; 1] as FromIntoMemory>::from_bytes(&from[16..16 + 56]);
        Self {
            Version: f_Version,
            Reserved0: f_Reserved0,
            ApplicationId: f_ApplicationId,
            Policies: f_Policies,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 72u32 as usize);
        FromIntoMemory::into_bytes(self.Version, &mut into[0..0 + 1]);
        FromIntoMemory::into_bytes(self.Reserved0, &mut into[1..1 + 7]);
        FromIntoMemory::into_bytes(self.ApplicationId, &mut into[8..8 + 8]);
        FromIntoMemory::into_bytes(self.Policies, &mut into[16..16 + 56]);
    }
    fn size() -> usize {
        72u32 as usize
    }
...
impl FromIntoMemory for IMAGE_RELOCATION {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 16u32 as usize);
        let f_Anonymous = <IMAGE_RELOCATION_0 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_SymbolTableIndex = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_Type = <u16 as FromIntoMemory>::from_bytes(&from[12..12 + 2]);
        Self {
            Anonymous: f_Anonymous,
            SymbolTableIndex: f_SymbolTableIndex,
            Type: f_Type,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 16u32 as usize);
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.SymbolTableIndex, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.Type, &mut into[12..12 + 2]);
    }
    fn size() -> usize {
        16u32 as usize
    }
}
pub struct IMAGE_RELOCATION_0 {
    pub VirtualAddress: u32,
    pub RelocCount: u32,
}
...
impl ::core::cmp::PartialEq for IMAGE_RELOCATION_0 {
    fn eq(&self, other: &Self) -> bool {
        self.VirtualAddress == other.VirtualAddress && self.RelocCount == other.RelocCount
    }
}
impl ::core::cmp::Eq for IMAGE_RELOCATION_0 {}
impl FromIntoMemory for IMAGE_RELOCATION_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for IMAGE_RESOURCE_DIRECTORY_ENTRY {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 20u32 as usize);
        let f_Anonymous1 =
            <IMAGE_RESOURCE_DIRECTORY_ENTRY_0 as FromIntoMemory>::from_bytes(&from[0..0 + 12]);
        let f_Anonymous2 =
            <IMAGE_RESOURCE_DIRECTORY_ENTRY_1 as FromIntoMemory>::from_bytes(&from[12..12 + 8]);
        Self {
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 20u32 as usize);
        FromIntoMemory::into_bytes(self.Anonymous1, &mut into[0..0 + 12]);
        FromIntoMemory::into_bytes(self.Anonymous2, &mut into[12..12 + 8]);
    }
    fn size() -> usize {
        20u32 as usize
    }
}
pub struct IMAGE_RESOURCE_DIRECTORY_ENTRY_0 {
...
impl ::core::cmp::PartialEq for IMAGE_RESOURCE_DIRECTORY_ENTRY_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Anonymous == other.Anonymous && self.Name == other.Name && self.Id == other.Id
    }
}
impl ::core::cmp::Eq for IMAGE_RESOURCE_DIRECTORY_ENTRY_0 {}
impl FromIntoMemory for IMAGE_RESOURCE_DIRECTORY_ENTRY_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for IMAGE_RESOURCE_DIRECTORY_ENTRY_0_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_RESOURCE_DIRECTORY_ENTRY_0_0")
            .field("_bitfield", &self._bitfield)
            .finish()
    }
}
...
impl FromIntoMemory for IMAGE_RESOURCE_DIRECTORY_ENTRY_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 4u32 as usize);
        let f__bitfield = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        Self {
...
pub struct IMAGE_RESOURCE_DIRECTORY_ENTRY_1 {
    pub OffsetToData: u32,
...
impl ::core::cmp::PartialEq for IMAGE_RESOURCE_DIRECTORY_ENTRY_1 {
    fn eq(&self, other: &Self) -> bool {
        self.OffsetToData == other.OffsetToData && self.Anonymous == other.Anonymous
    }
}
impl ::core::cmp::Eq for IMAGE_RESOURCE_DIRECTORY_ENTRY_1 {}
impl FromIntoMemory for IMAGE_RESOURCE_DIRECTORY_ENTRY_1 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for IMAGE_RESOURCE_DIRECTORY_ENTRY_1_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_RESOURCE_DIRECTORY_ENTRY_1_0")
            .field("_bitfield", &self._bitfield)
            .finish()
    }
}
...
impl FromIntoMemory for IMAGE_RESOURCE_DIRECTORY_ENTRY_1_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 4u32 as usize);
        let f__bitfield = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        Self {
...
impl FromIntoMemory for IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 2u32 as usize);
        let f__bitfield = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        Self {
...
impl ::core::cmp::PartialEq for IMAGE_SYMBOL {
    fn eq(&self, other: &Self) -> bool {
        self.N == other.N
            ...
            && self.SectionNumber == other.SectionNumber
            && self.Type == other.Type
            && self.StorageClass == other.StorageClass
            && self.NumberOfAuxSymbols == other.NumberOfAuxSymbols
    }
}
impl ::core::cmp::Eq for IMAGE_SYMBOL {}
impl FromIntoMemory for IMAGE_SYMBOL {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 36u32 as usize);
        let f_N = <IMAGE_SYMBOL_0 as FromIntoMemory>::from_bytes(&from[0..0 + 24]);
        let f_Value = <u32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_SectionNumber = <i16 as FromIntoMemory>::from_bytes(&from[28..28 + 2]);
        let f_Type = <u16 as FromIntoMemory>::from_bytes(&from[30..30 + 2]);
        let f_StorageClass = <u8 as FromIntoMemory>::from_bytes(&from[32..32 + 1]);
        let f_NumberOfAuxSymbols = <u8 as FromIntoMemory>::from_bytes(&from[33..33 + 1]);
        Self {
            N: f_N,
            Value: f_Value,
            SectionNumber: f_SectionNumber,
            Type: f_Type,
            StorageClass: f_StorageClass,
            NumberOfAuxSymbols: f_NumberOfAuxSymbols,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 36u32 as usize);
        FromIntoMemory::into_bytes(self.N, &mut into[0..0 + 24]);
        FromIntoMemory::into_bytes(self.Value, &mut into[24..24 + 4]);
        FromIntoMemory::into_bytes(self.SectionNumber, &mut into[28..28 + 2]);
        FromIntoMemory::into_bytes(self.Type, &mut into[30..30 + 2]);
        FromIntoMemory::into_bytes(self.StorageClass, &mut into[32..32 + 1]);
        FromIntoMemory::into_bytes(self.NumberOfAuxSymbols, &mut into[33..33 + 1]);
    }
    fn size() -> usize {
        36u32 as usize
    }
}
pub struct IMAGE_SYMBOL_0 {
    pub ShortName: [u8; 8],
...
impl FromIntoMemory for IMAGE_SYMBOL_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for IMAGE_SYMBOL_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_Short = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_Long = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        Self {
            Short: f_Short,
            Long: f_Long,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 8u32 as usize);
        FromIntoMemory::into_bytes(self.Short, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.Long, &mut into[4..4 + 4]);
    }
    fn size() -> usize {
        8u32 as usize
    }
...
impl FromIntoMemory for IMAGE_SYMBOL_EX {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 36u32 as usize);
        let f_N = <IMAGE_SYMBOL_EX_0 as FromIntoMemory>::from_bytes(&from[0..0 + 24]);
        let f_Value = <u32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_SectionNumber = <i32 as FromIntoMemory>::from_bytes(&from[28..28 + 4]);
        let f_Type = <u16 as FromIntoMemory>::from_bytes(&from[32..32 + 2]);
        let f_StorageClass = <u8 as FromIntoMemory>::from_bytes(&from[34..34 + 1]);
        let f_NumberOfAuxSymbols = <u8 as FromIntoMemory>::from_bytes(&from[35..35 + 1]);
        Self {
            N: f_N,
            Value: f_Value,
            SectionNumber: f_SectionNumber,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.N, &mut into[0..0 + 24]);
        FromIntoMemory::into_bytes(self.Value, &mut into[24..24 + 4]);
        FromIntoMemory::into_bytes(self.SectionNumber, &mut into[28..28 + 4]);
        FromIntoMemory::into_bytes(self.Type, &mut into[32..32 + 2]);
        FromIntoMemory::into_bytes(self.StorageClass, &mut into[34..34 + 1]);
        FromIntoMemory::into_bytes(self.NumberOfAuxSymbols, &mut into[35..35 + 1]);
    }
    fn size() -> usize {
        36u32 as usize
    }
}
pub struct IMAGE_SYMBOL_EX_0 {
    pub ShortName: [u8; 8],
...
impl FromIntoMemory for IMAGE_SYMBOL_EX_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for IMAGE_SYMBOL_EX_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_Short = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_Long = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
...
impl ::core::cmp::PartialEq for IMAGE_TLS_DIRECTORY32 {
    fn eq(&self, other: &Self) -> bool {
        self.StartAddressOfRawData == other.StartAddressOfRawData
            && self.EndAddressOfRawData == other.EndAddressOfRawData
            && self.AddressOfIndex == other.AddressOfIndex
            && self.AddressOfCallBacks == other.AddressOfCallBacks
            && self.SizeOfZeroFill == other.SizeOfZeroFill
            && self.Anonymous == other.Anonymous
    }
}
impl ::core::cmp::Eq for IMAGE_TLS_DIRECTORY32 {}
impl FromIntoMemory for IMAGE_TLS_DIRECTORY32 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 28u32 as usize);
        let f_StartAddressOfRawData = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_EndAddressOfRawData = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_AddressOfIndex = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_AddressOfCallBacks = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_SizeOfZeroFill = <u32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        let f_Anonymous =
            <IMAGE_TLS_DIRECTORY32_0 as FromIntoMemory>::from_bytes(&from[20..20 + 8]);
        Self {
            StartAddressOfRawData: f_StartAddressOfRawData,
            EndAddressOfRawData: f_EndAddressOfRawData,
            AddressOfIndex: f_AddressOfIndex,
            AddressOfCallBacks: f_AddressOfCallBacks,
            SizeOfZeroFill: f_SizeOfZeroFill,
            Anonymous: f_Anonymous,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 28u32 as usize);
        FromIntoMemory::into_bytes(self.StartAddressOfRawData, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.EndAddressOfRawData, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.AddressOfIndex, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.AddressOfCallBacks, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.SizeOfZeroFill, &mut into[16..16 + 4]);
...
pub struct IMAGE_TLS_DIRECTORY32_0 {
    pub Characteristics: u32,
...
impl ::core::cmp::PartialEq for IMAGE_TLS_DIRECTORY32_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Characteristics == other.Characteristics && self.Anonymous == other.Anonymous
    }
}
impl ::core::cmp::Eq for IMAGE_TLS_DIRECTORY32_0 {}
impl FromIntoMemory for IMAGE_TLS_DIRECTORY32_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for IMAGE_TLS_DIRECTORY32_0_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_TLS_DIRECTORY32_0_0")
            .field("_bitfield", &self._bitfield)
            .finish()
    }
}
...
impl FromIntoMemory for IMAGE_TLS_DIRECTORY32_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 4u32 as usize);
        let f__bitfield = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        Self {
...
impl FromIntoMemory for IMAGE_TLS_DIRECTORY64 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 48u32 as usize);
        let f_StartAddressOfRawData = <u64 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_EndAddressOfRawData = <u64 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        let f_AddressOfIndex = <u64 as FromIntoMemory>::from_bytes(&from[16..16 + 8]);
        let f_AddressOfCallBacks = <u64 as FromIntoMemory>::from_bytes(&from[24..24 + 8]);
        let f_SizeOfZeroFill = <u32 as FromIntoMemory>::from_bytes(&from[32..32 + 4]);
        let f_Anonymous =
            <IMAGE_TLS_DIRECTORY64_0 as FromIntoMemory>::from_bytes(&from[36..36 + 8]);
        Self {
            StartAddressOfRawData: f_StartAddressOfRawData,
            EndAddressOfRawData: f_EndAddressOfRawData,
            AddressOfIndex: f_AddressOfIndex,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 48u32 as usize);
        FromIntoMemory::into_bytes(self.StartAddressOfRawData, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.EndAddressOfRawData, &mut into[8..8 + 8]);
        FromIntoMemory::into_bytes(self.AddressOfIndex, &mut into[16..16 + 8]);
        FromIntoMemory::into_bytes(self.AddressOfCallBacks, &mut into[24..24 + 8]);
        FromIntoMemory::into_bytes(self.SizeOfZeroFill, &mut into[32..32 + 4]);
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[36..36 + 8]);
    }
    fn size() -> usize {
        48u32 as usize
    }
}
pub struct IMAGE_TLS_DIRECTORY64_0 {
    pub Characteristics: u32,
...
impl FromIntoMemory for IMAGE_TLS_DIRECTORY64_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for IMAGE_TLS_DIRECTORY64_0_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("IMAGE_TLS_DIRECTORY64_0_0")
            .field("_bitfield", &self._bitfield)
            .finish()
    }
}
...
impl FromIntoMemory for IMAGE_TLS_DIRECTORY64_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 4u32 as usize);
        let f__bitfield = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        Self {
...
impl ::core::cmp::PartialEq for IMAGE_VXD_HEADER {
    fn eq(&self, other: &Self) -> bool {
        self.e32_magic == other.e32_magic
            && self.e32_border == other.e32_border
            && self.e32_worder == other.e32_worder
            && self.e32_level == other.e32_level
            && self.e32_cpu == other.e32_cpu
            && self.e32_os == other.e32_os
            && self.e32_ver == other.e32_ver
            && self.e32_mflags == other.e32_mflags
            && self.e32_mpages == other.e32_mpages
            && self.e32_startobj == other.e32_startobj
            && self.e32_eip == other.e32_eip
            && self.e32_stackobj == other.e32_stackobj
            && self.e32_esp == other.e32_esp
            && self.e32_pagesize == other.e32_pagesize
            && self.e32_lastpagesize == other.e32_lastpagesize
            && self.e32_fixupsize == other.e32_fixupsize
            && self.e32_fixupsum == other.e32_fixupsum
            && self.e32_ldrsize == other.e32_ldrsize
            && self.e32_ldrsum == other.e32_ldrsum
            && self.e32_objtab == other.e32_objtab
            && self.e32_objcnt == other.e32_objcnt
            && self.e32_objmap == other.e32_objmap
            && self.e32_itermap == other.e32_itermap
            && self.e32_rsrctab == other.e32_rsrctab
            && self.e32_rsrccnt == other.e32_rsrccnt
            && self.e32_restab == other.e32_restab
            && self.e32_enttab == other.e32_enttab
            && self.e32_dirtab == other.e32_dirtab
            && self.e32_dircnt == other.e32_dircnt
            && self.e32_fpagetab == other.e32_fpagetab
            && self.e32_frectab == other.e32_frectab
            && self.e32_impmod == other.e32_impmod
            && self.e32_impmodcnt == other.e32_impmodcnt
            && self.e32_impproc == other.e32_impproc
            && self.e32_pagesum == other.e32_pagesum
            && self.e32_datapage == other.e32_datapage
            && self.e32_preload == other.e32_preload
            && self.e32_nrestab == other.e32_nrestab
            && self.e32_cbnrestab == other.e32_cbnrestab
            && self.e32_nressum == other.e32_nressum
            && self.e32_autodata == other.e32_autodata
            && self.e32_debuginfo == other.e32_debuginfo
            && self.e32_debuglen == other.e32_debuglen
            && self.e32_instpreload == other.e32_instpreload
            && self.e32_instdemand == other.e32_instdemand
            && self.e32_heapsize == other.e32_heapsize
            && self.e32_res3 == other.e32_res3
            && self.e32_winresoff == other.e32_winresoff
            && self.e32_winreslen == other.e32_winreslen
            && self.e32_devid == other.e32_devid
            && self.e32_ddkver == other.e32_ddkver
    }
}
impl ::core::cmp::Eq for IMAGE_VXD_HEADER {}
impl FromIntoMemory for IMAGE_VXD_HEADER {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 196u32 as usize);
        let f_e32_magic = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        let f_e32_border = <u8 as FromIntoMemory>::from_bytes(&from[2..2 + 1]);
        let f_e32_worder = <u8 as FromIntoMemory>::from_bytes(&from[3..3 + 1]);
        let f_e32_level = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_e32_cpu = <u16 as FromIntoMemory>::from_bytes(&from[8..8 + 2]);
        let f_e32_os = <u16 as FromIntoMemory>::from_bytes(&from[10..10 + 2]);
        let f_e32_ver = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_e32_mflags = <u32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        let f_e32_mpages = <u32 as FromIntoMemory>::from_bytes(&from[20..20 + 4]);
        let f_e32_startobj = <u32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_e32_eip = <u32 as FromIntoMemory>::from_bytes(&from[28..28 + 4]);
        let f_e32_stackobj = <u32 as FromIntoMemory>::from_bytes(&from[32..32 + 4]);
        let f_e32_esp = <u32 as FromIntoMemory>::from_bytes(&from[36..36 + 4]);
        let f_e32_pagesize = <u32 as FromIntoMemory>::from_bytes(&from[40..40 + 4]);
        let f_e32_lastpagesize = <u32 as FromIntoMemory>::from_bytes(&from[44..44 + 4]);
        let f_e32_fixupsize = <u32 as FromIntoMemory>::from_bytes(&from[48..48 + 4]);
        let f_e32_fixupsum = <u32 as FromIntoMemory>::from_bytes(&from[52..52 + 4]);
        let f_e32_ldrsize = <u32 as FromIntoMemory>::from_bytes(&from[56..56 + 4]);
        let f_e32_ldrsum = <u32 as FromIntoMemory>::from_bytes(&from[60..60 + 4]);
        let f_e32_objtab = <u32 as FromIntoMemory>::from_bytes(&from[64..64 + 4]);
        let f_e32_objcnt = <u32 as FromIntoMemory>::from_bytes(&from[68..68 + 4]);
        let f_e32_objmap = <u32 as FromIntoMemory>::from_bytes(&from[72..72 + 4]);
        let f_e32_itermap = <u32 as FromIntoMemory>::from_bytes(&from[76..76 + 4]);
        let f_e32_rsrctab = <u32 as FromIntoMemory>::from_bytes(&from[80..80 + 4]);
        let f_e32_rsrccnt = <u32 as FromIntoMemory>::from_bytes(&from[84..84 + 4]);
        let f_e32_restab = <u32 as FromIntoMemory>::from_bytes(&from[88..88 + 4]);
        let f_e32_enttab = <u32 as FromIntoMemory>::from_bytes(&from[92..92 + 4]);
        let f_e32_dirtab = <u32 as FromIntoMemory>::from_bytes(&from[96..96 + 4]);
        let f_e32_dircnt = <u32 as FromIntoMemory>::from_bytes(&from[100..100 + 4]);
        let f_e32_fpagetab = <u32 as FromIntoMemory>::from_bytes(&from[104..104 + 4]);
        let f_e32_frectab = <u32 as FromIntoMemory>::from_bytes(&from[108..108 + 4]);
        let f_e32_impmod = <u32 as FromIntoMemory>::from_bytes(&from[112..112 + 4]);
        let f_e32_impmodcnt = <u32 as FromIntoMemory>::from_bytes(&from[116..116 + 4]);
        let f_e32_impproc = <u32 as FromIntoMemory>::from_bytes(&from[120..120 + 4]);
        let f_e32_pagesum = <u32 as FromIntoMemory>::from_bytes(&from[124..124 + 4]);
        let f_e32_datapage = <u32 as FromIntoMemory>::from_bytes(&from[128..128 + 4]);
        let f_e32_preload = <u32 as FromIntoMemory>::from_bytes(&from[132..132 + 4]);
        let f_e32_nrestab = <u32 as FromIntoMemory>::from_bytes(&from[136..136 + 4]);
        let f_e32_cbnrestab = <u32 as FromIntoMemory>::from_bytes(&from[140..140 + 4]);
        let f_e32_nressum = <u32 as FromIntoMemory>::from_bytes(&from[144..144 + 4]);
        let f_e32_autodata = <u32 as FromIntoMemory>::from_bytes(&from[148..148 + 4]);
        let f_e32_debuginfo = <u32 as FromIntoMemory>::from_bytes(&from[152..152 + 4]);
        let f_e32_debuglen = <u32 as FromIntoMemory>::from_bytes(&from[156..156 + 4]);
        let f_e32_instpreload = <u32 as FromIntoMemory>::from_bytes(&from[160..160 + 4]);
        let f_e32_instdemand = <u32 as FromIntoMemory>::from_bytes(&from[164..164 + 4]);
        let f_e32_heapsize = <u32 as FromIntoMemory>::from_bytes(&from[168..168 + 4]);
        let f_e32_res3 = <[u8; 12] as FromIntoMemory>::from_bytes(&from[172..172 + 12]);
        let f_e32_winresoff = <u32 as FromIntoMemory>::from_bytes(&from[184..184 + 4]);
        let f_e32_winreslen = <u32 as FromIntoMemory>::from_bytes(&from[188..188 + 4]);
        let f_e32_devid = <u16 as FromIntoMemory>::from_bytes(&from[192..192 + 2]);
        let f_e32_ddkver = <u16 as FromIntoMemory>::from_bytes(&from[194..194 + 2]);
        Self {
            e32_magic: f_e32_magic,
            e32_border: f_e32_border,
            e32_worder: f_e32_worder,
            e32_level: f_e32_level,
            e32_cpu: f_e32_cpu,
            e32_os: f_e32_os,
            e32_ver: f_e32_ver,
            e32_mflags: f_e32_mflags,
            e32_mpages: f_e32_mpages,
            e32_startobj: f_e32_startobj,
            e32_eip: f_e32_eip,
            e32_stackobj: f_e32_stackobj,
            e32_esp: f_e32_esp,
            e32_pagesize: f_e32_pagesize,
            e32_lastpagesize: f_e32_lastpagesize,
            e32_fixupsize: f_e32_fixupsize,
            e32_fixupsum: f_e32_fixupsum,
            e32_ldrsize: f_e32_ldrsize,
            e32_ldrsum: f_e32_ldrsum,
            e32_objtab: f_e32_objtab,
            e32_objcnt: f_e32_objcnt,
            e32_objmap: f_e32_objmap,
            e32_itermap: f_e32_itermap,
            e32_rsrctab: f_e32_rsrctab,
            e32_rsrccnt: f_e32_rsrccnt,
            e32_restab: f_e32_restab,
            e32_enttab: f_e32_enttab,
            e32_dirtab: f_e32_dirtab,
            e32_dircnt: f_e32_dircnt,
            e32_fpagetab: f_e32_fpagetab,
            e32_frectab: f_e32_frectab,
            e32_impmod: f_e32_impmod,
            e32_impmodcnt: f_e32_impmodcnt,
            e32_impproc: f_e32_impproc,
            e32_pagesum: f_e32_pagesum,
            e32_datapage: f_e32_datapage,
            e32_preload: f_e32_preload,
            e32_nrestab: f_e32_nrestab,
            e32_cbnrestab: f_e32_cbnrestab,
            e32_nressum: f_e32_nressum,
            e32_autodata: f_e32_autodata,
            e32_debuginfo: f_e32_debuginfo,
            e32_debuglen: f_e32_debuglen,
            e32_instpreload: f_e32_instpreload,
            e32_instdemand: f_e32_instdemand,
            e32_heapsize: f_e32_heapsize,
            e32_res3: f_e32_res3,
            e32_winresoff: f_e32_winresoff,
            e32_winreslen: f_e32_winreslen,
            e32_devid: f_e32_devid,
            e32_ddkver: f_e32_ddkver,
        }
    }
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 196u32 as usize);
        FromIntoMemory::into_bytes(self.e32_magic, &mut into[0..0 + 2]);
        FromIntoMemory::into_bytes(self.e32_border, &mut into[2..2 + 1]);
        FromIntoMemory::into_bytes(self.e32_worder, &mut into[3..3 + 1]);
        FromIntoMemory::into_bytes(self.e32_level, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.e32_cpu, &mut into[8..8 + 2]);
        FromIntoMemory::into_bytes(self.e32_os, &mut into[10..10 + 2]);
        FromIntoMemory::into_bytes(self.e32_ver, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.e32_mflags, &mut into[16..16 + 4]);
        FromIntoMemory::into_bytes(self.e32_mpages, &mut into[20..20 + 4]);
        FromIntoMemory::into_bytes(self.e32_startobj, &mut into[24..24 + 4]);
        FromIntoMemory::into_bytes(self.e32_eip, &mut into[28..28 + 4]);
        FromIntoMemory::into_bytes(self.e32_stackobj, &mut into[32..32 + 4]);
        FromIntoMemory::into_bytes(self.e32_esp, &mut into[36..36 + 4]);
        FromIntoMemory::into_bytes(self.e32_pagesize, &mut into[40..40 + 4]);
        FromIntoMemory::into_bytes(self.e32_lastpagesize, &mut into[44..44 + 4]);
        FromIntoMemory::into_bytes(self.e32_fixupsize, &mut into[48..48 + 4]);
        FromIntoMemory::into_bytes(self.e32_fixupsum, &mut into[52..52 + 4]);
        FromIntoMemory::into_bytes(self.e32_ldrsize, &mut into[56..56 + 4]);
        FromIntoMemory::into_bytes(self.e32_ldrsum, &mut into[60..60 + 4]);
        FromIntoMemory::into_bytes(self.e32_objtab, &mut into[64..64 + 4]);
        FromIntoMemory::into_bytes(self.e32_objcnt, &mut into[68..68 + 4]);
        FromIntoMemory::into_bytes(self.e32_objmap, &mut into[72..72 + 4]);
        FromIntoMemory::into_bytes(self.e32_itermap, &mut into[76..76 + 4]);
        FromIntoMemory::into_bytes(self.e32_rsrctab, &mut into[80..80 + 4]);
        FromIntoMemory::into_bytes(self.e32_rsrccnt, &mut into[84..84 + 4]);
        FromIntoMemory::into_bytes(self.e32_restab, &mut into[88..88 + 4]);
        FromIntoMemory::into_bytes(self.e32_enttab, &mut into[92..92 + 4]);
        FromIntoMemory::into_bytes(self.e32_dirtab, &mut into[96..96 + 4]);
        FromIntoMemory::into_bytes(self.e32_dircnt, &mut into[100..100 + 4]);
        FromIntoMemory::into_bytes(self.e32_fpagetab, &mut into[104..104 + 4]);
        FromIntoMemory::into_bytes(self.e32_frectab, &mut into[108..108 + 4]);
        FromIntoMemory::into_bytes(self.e32_impmod, &mut into[112..112 + 4]);
        FromIntoMemory::into_bytes(self.e32_impmodcnt, &mut into[116..116 + 4]);
        FromIntoMemory::into_bytes(self.e32_impproc, &mut into[120..120 + 4]);
        FromIntoMemory::into_bytes(self.e32_pagesum, &mut into[124..124 + 4]);
        FromIntoMemory::into_bytes(self.e32_datapage, &mut into[128..128 + 4]);
        FromIntoMemory::into_bytes(self.e32_preload, &mut into[132..132 + 4]);
        FromIntoMemory::into_bytes(self.e32_nrestab, &mut into[136..136 + 4]);
        FromIntoMemory::into_bytes(self.e32_cbnrestab, &mut into[140..140 + 4]);
        FromIntoMemory::into_bytes(self.e32_nressum, &mut into[144..144 + 4]);
        FromIntoMemory::into_bytes(self.e32_autodata, &mut into[148..148 + 4]);
        FromIntoMemory::into_bytes(self.e32_debuginfo, &mut into[152..152 + 4]);
        FromIntoMemory::into_bytes(self.e32_debuglen, &mut into[156..156 + 4]);
        FromIntoMemory::into_bytes(self.e32_instpreload, &mut into[160..160 + 4]);
        FromIntoMemory::into_bytes(self.e32_instdemand, &mut into[164..164 + 4]);
        FromIntoMemory::into_bytes(self.e32_heapsize, &mut into[168..168 + 4]);
        FromIntoMemory::into_bytes(self.e32_res3, &mut into[172..172 + 12]);
        FromIntoMemory::into_bytes(self.e32_winresoff, &mut into[184..184 + 4]);
        FromIntoMemory::into_bytes(self.e32_winreslen, &mut into[188..188 + 4]);
        FromIntoMemory::into_bytes(self.e32_devid, &mut into[192..192 + 2]);
        FromIntoMemory::into_bytes(self.e32_ddkver, &mut into[194..194 + 2]);
    }
    fn size() -> usize {
        196u32 as usize
    }
...
impl FromIntoMemory for IMPORT_OBJECT_HEADER {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_Sig1 = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        let f_Sig2 = <u16 as FromIntoMemory>::from_bytes(&from[2..2 + 2]);
        ...
        let f_Machine = <u16 as FromIntoMemory>::from_bytes(&from[6..6 + 2]);
        let f_TimeDateStamp = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_SizeOfData = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_Anonymous = <IMPORT_OBJECT_HEADER_0 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        let f__bitfield = <u16 as FromIntoMemory>::from_bytes(&from[20..20 + 2]);
        Self {
            Sig1: f_Sig1,
            Sig2: f_Sig2,
            Version: f_Version,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.Machine, &mut into[6..6 + 2]);
        FromIntoMemory::into_bytes(self.TimeDateStamp, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.SizeOfData, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[16..16 + 4]);
        FromIntoMemory::into_bytes(self._bitfield, &mut into[20..20 + 2]);
    }
    fn size() -> usize {
        24u32 as usize
    }
}
pub struct IMPORT_OBJECT_HEADER_0 {
    pub Ordinal: u16,
    pub Hint: u16,
}
...
impl ::core::cmp::PartialEq for IMPORT_OBJECT_HEADER_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Ordinal == other.Ordinal && self.Hint == other.Hint
    }
}
impl ::core::cmp::Eq for IMPORT_OBJECT_HEADER_0 {}
impl FromIntoMemory for IMPORT_OBJECT_HEADER_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for KERNEL_CET_CONTEXT {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 32u32 as usize);
        let f_Ssp = <u64 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_Rip = <u64 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        let f_SegCs = <u16 as FromIntoMemory>::from_bytes(&from[16..16 + 2]);
        let f_Anonymous = <KERNEL_CET_CONTEXT_0 as FromIntoMemory>::from_bytes(&from[18..18 + 4]);
        let f_Fill = <[u16; 2] as FromIntoMemory>::from_bytes(&from[22..22 + 4]);
        Self {
            Ssp: f_Ssp,
            Rip: f_Rip,
            SegCs: f_SegCs,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 32u32 as usize);
        FromIntoMemory::into_bytes(self.Ssp, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.Rip, &mut into[8..8 + 8]);
        FromIntoMemory::into_bytes(self.SegCs, &mut into[16..16 + 2]);
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[18..18 + 4]);
        FromIntoMemory::into_bytes(self.Fill, &mut into[22..22 + 4]);
    }
    fn size() -> usize {
        32u32 as usize
    }
}
pub struct KERNEL_CET_CONTEXT_0 {
    pub AllFlags: u16,
...
impl FromIntoMemory for KERNEL_CET_CONTEXT_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl ::core::fmt::Debug for KERNEL_CET_CONTEXT_0_0 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("KERNEL_CET_CONTEXT_0_0")
            .field("_bitfield", &self._bitfield)
            .finish()
    }
}
...
impl FromIntoMemory for KERNEL_CET_CONTEXT_0_0 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 2u32 as usize);
        let f__bitfield = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        Self {
...
impl FromIntoMemory for NON_PAGED_DEBUG_INFO {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 32u32 as usize);
        let f_Signature = <u16 as FromIntoMemory>::from_bytes(&from[0..0 + 2]);
        let f_Flags = <u16 as FromIntoMemory>::from_bytes(&from[2..2 + 2]);
        let f_Size = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_Machine = <u16 as FromIntoMemory>::from_bytes(&from[8..8 + 2]);
        let f_Characteristics = <u16 as FromIntoMemory>::from_bytes(&from[10..10 + 2]);
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.Flags, &mut into[2..2 + 2]);
        FromIntoMemory::into_bytes(self.Size, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.Machine, &mut into[8..8 + 2]);
        FromIntoMemory::into_bytes(self.Characteristics, &mut into[10..10 + 2]);
...
impl FromIntoMemory for NT_TIB32 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 32u32 as usize);
        let f_ExceptionList = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_StackBase = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_StackLimit = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_SubSystemTib = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_Anonymous = <NT_TIB32_0 as FromIntoMemory>::from_bytes(&from[16..16 + 8]);
        let f_ArbitraryUserPointer = <u32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_Self = <u32 as FromIntoMemory>::from_bytes(&from[28..28 + 4]);
        Self {
...
impl FromIntoMemory for NT_TIB32_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for NT_TIB64 {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 64u32 as usize);
        let f_ExceptionList = <u64 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_StackBase = <u64 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        let f_StackLimit = <u64 as FromIntoMemory>::from_bytes(&from[16..16 + 8]);
        let f_SubSystemTib = <u64 as FromIntoMemory>::from_bytes(&from[24..24 + 8]);
        let f_Anonymous = <NT_TIB64_0 as FromIntoMemory>::from_bytes(&from[32..32 + 16]);
        let f_ArbitraryUserPointer = <u64 as FromIntoMemory>::from_bytes(&from[48..48 + 8]);
        let f_Self = <u64 as FromIntoMemory>::from_bytes(&from[56..56 + 8]);
        Self {
            ExceptionList: f_ExceptionList,
            StackBase: f_StackBase,
            StackLimit: f_StackLimit,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 64u32 as usize);
        FromIntoMemory::into_bytes(self.ExceptionList, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.StackBase, &mut into[8..8 + 8]);
        FromIntoMemory::into_bytes(self.StackLimit, &mut into[16..16 + 8]);
        FromIntoMemory::into_bytes(self.SubSystemTib, &mut into[24..24 + 8]);
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[32..32 + 16]);
        FromIntoMemory::into_bytes(self.ArbitraryUserPointer, &mut into[48..48 + 8]);
        FromIntoMemory::into_bytes(self.Self_, &mut into[56..56 + 8]);
    }
    fn size() -> usize {
        64u32 as usize
    }
}
pub struct NT_TIB64_0 {
    pub FiberData: u64,
    pub Version: u32,
}
...
impl FromIntoMemory for NT_TIB64_0 {
    fn from_bytes(from: &[u8]) -> Self {
        todo!()
    }
    fn into_bytes(self, into: &mut [u8]) {
...
impl FromIntoMemory for PPM_IDLE_ACCOUNTING_EX {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 440u32 as usize);
        let f_StateCount = <u32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_TotalTransitions = <u32 as FromIntoMemory>::from_bytes(&from[4..4 + 4]);
        let f_ResetCount = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 440u32 as usize);
        FromIntoMemory::into_bytes(self.StateCount, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.TotalTransitions, &mut into[4..4 + 4]);
        FromIntoMemory::into_bytes(self.ResetCount, &mut into[8..8 + 4]);
...
impl FromIntoMemory for PROCESSOR_IDLESTATE_POLICY {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_Flags = <PROCESSOR_IDLESTATE_POLICY_0 as FromIntoMemory>::from_bytes(&from[2..2 + 4]);
        let f_PolicyCount = <u32 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_Policy =
            <[PROCESSOR_IDLESTATE_INFO; 3] as FromIntoMemory>::from_bytes(&from[12..12 + 24]);
        Self {
            Revision: f_Revision,
            Flags: f_Flags,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.PolicyCount, &mut into[8..8 + 4]);
        FromIntoMemory::into_bytes(self.Policy, &mut into[12..12 + 24]);
    }
    fn size() -> usize {
        36u32 as usize
    }
...
impl ::core::cmp::PartialEq for PROCESSOR_IDLESTATE_POLICY_0 {
    fn eq(&self, other: &Self) -> bool {
        self.AsWORD == other.AsWORD && self.Anonymous == other.Anonymous
    }
}
...
impl FromIntoMemory for PROCESSOR_PERFSTATE_POLICY {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_Anonymous =
            <PROCESSOR_PERFSTATE_POLICY_0 as FromIntoMemory>::from_bytes(&from[7..7 + 3]);
        let f_TimeCheck = <u32 as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_IncreaseTime = <u32 as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        let f_DecreaseTime = <u32 as FromIntoMemory>::from_bytes(&from[20..20 + 4]);
        let f_IncreasePercent = <u32 as FromIntoMemory>::from_bytes(&from[24..24 + 4]);
        let f_DecreasePercent = <u32 as FromIntoMemory>::from_bytes(&from[28..28 + 4]);
        Self {
            Revision: f_Revision,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[7..7 + 3]);
        FromIntoMemory::into_bytes(self.TimeCheck, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.IncreaseTime, &mut into[16..16 + 4]);
        FromIntoMemory::into_bytes(self.DecreaseTime, &mut into[20..20 + 4]);
        FromIntoMemory::into_bytes(self.IncreasePercent, &mut into[24..24 + 4]);
        FromIntoMemory::into_bytes(self.DecreasePercent, &mut into[28..28 + 4]);
    }
    fn size() -> usize {
        32u32 as usize
    }
...
impl ::core::cmp::PartialEq for PROCESSOR_PERFSTATE_POLICY_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Spare == other.Spare && self.Flags == other.Flags
    }
}
...
impl ::core::cmp::PartialEq for PROCESSOR_PERFSTATE_POLICY_0_0 {
    fn eq(&self, other: &Self) -> bool {
        self.AsBYTE == other.AsBYTE && self.Anonymous == other.Anonymous
    }
}
...
impl FromIntoMemory for PROCESS_MITIGATION_ASLR_POLICY {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_Anonymous =
            <PROCESS_MITIGATION_ASLR_POLICY_0 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        Self {
            Anonymous: f_Anonymous,
        }
    }
...
impl FromIntoMemory for PROCESS_MITIGATION_DEP_POLICY {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 12u32 as usize);
        let f_Anonymous =
            <PROCESS_MITIGATION_DEP_POLICY_0 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        let f_Permanent =
            <super::super::Foundation::BOOLEAN as FromIntoMemory>::from_bytes(&from[8..8 + 1]);
        Self {
            Anonymous: f_Anonymous,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 12u32 as usize);
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[0..0 + 8]);
        FromIntoMemory::into_bytes(self.Permanent, &mut into[8..8 + 1]);
    }
    fn size() -> usize {
        12u32 as usize
    }
...
impl FromIntoMemory for PROCESS_MITIGATION_IMAGE_LOAD_POLICY {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 8u32 as usize);
        let f_Anonymous =
            <PROCESS_MITIGATION_IMAGE_LOAD_POLICY_0 as FromIntoMemory>::from_bytes(&from[0..0 + 8]);
        Self {
            Anonymous: f_Anonymous,
        }
    }
...
impl FromIntoMemory for QUOTA_LIMITS_EX {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_CpuRateLimit = <RATE_QUOTA_LIMIT as FromIntoMemory>::from_bytes(&from[52..52 + 8]);
        Self {
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.CpuRateLimit, &mut into[52..52 + 8]);
    }
    fn size() -> usize {
        64u32 as usize
    }
...
impl ::core::cmp::PartialEq for RATE_QUOTA_LIMIT {
    fn eq(&self, other: &Self) -> bool {
        self.RateData == other.RateData && self.Anonymous == other.Anonymous
    }
}
...
impl FromIntoMemory for RemotableHandle {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 12u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <RemotableHandle_0 as FromIntoMemory>::from_bytes(&from[4..4 + 8]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
...
impl FromIntoMemory for SCRUB_DATA_INPUT {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 1232u32 as usize);
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 1232u32 as usize);
...
impl FromIntoMemory for SE_TOKEN_USER {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_Anonymous1 = <SE_TOKEN_USER_0 as FromIntoMemory>::from_bytes(&from[0..0 + 16]);
        let f_Anonymous2 = <SE_TOKEN_USER_1 as FromIntoMemory>::from_bytes(&from[16..16 + 80]);
        Self {
            Anonymous1: f_Anonymous1,
            Anonymous2: f_Anonymous2,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.Anonymous2, &mut into[16..16 + 80]);
    }
    fn size() -> usize {
        96u32 as usize
    }
...
impl ::core::cmp::PartialEq for SE_TOKEN_USER_0 {
    fn eq(&self, other: &Self) -> bool {
        self.TokenUser == other.TokenUser && self.User == other.User
    }
}
#[doc = "*Required namespaces: 'Windows.Win32.Foundation', 'Windows.Win32.Security'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl ::core::cmp::PartialEq for SE_TOKEN_USER_1 {
    fn eq(&self, other: &Self) -> bool {
        self.Sid == other.Sid && self.Buffer == other.Buffer
    }
}
#[doc = "*Required namespaces: 'Windows.Win32.Foundation', 'Windows.Win32.Security'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl FromIntoMemory for userCLIPFORMAT {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 12u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userCLIPFORMAT_0 as FromIntoMemory>::from_bytes(&from[4..4 + 8]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
...
impl ::core::cmp::PartialEq for userCLIPFORMAT_0 {
    fn eq(&self, other: &Self) -> bool {
        self.dwValue == other.dwValue && self.pwszName == other.pwszName
    }
}
...
impl FromIntoMemory for userHBITMAP {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userHBITMAP_0 as FromIntoMemory>::from_bytes(&from[8..8 + 16]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
    ...
    fn into_bytes(self, into: &mut [u8]) {
        assert_eq!(into.len(), 24u32 as usize);
        FromIntoMemory::into_bytes(self.fContext, &mut into[0..0 + 4]);
        FromIntoMemory::into_bytes(self.u, &mut into[8..8 + 16]);
    }
    fn size() -> usize {
        24u32 as usize
    }
...
impl FromIntoMemory for userHENHMETAFILE {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userHENHMETAFILE_0 as FromIntoMemory>::from_bytes(&from[8..8 + 16]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
...
pub struct userHENHMETAFILE_0 {
    pub hInproc: i32,
    pub hRemote: MutPtr<super::Com::BYTE_BLOB>,
    pub hInproc64: i64,
}
#[doc = "*Required namespaces: 'Windows.Win32.System.Com'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl FromIntoMemory for userHGLOBAL {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userHGLOBAL_0 as FromIntoMemory>::from_bytes(&from[8..8 + 16]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
...
pub struct userHGLOBAL_0 {
    pub hInproc: i32,
    pub hRemote: MutPtr<super::Com::FLAGGED_BYTE_BLOB>,
    pub hInproc64: i64,
}
#[doc = "*Required namespaces: 'Windows.Win32.System.Com'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl FromIntoMemory for userHMETAFILE {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userHMETAFILE_0 as FromIntoMemory>::from_bytes(&from[8..8 + 16]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
...
impl FromIntoMemory for userHMETAFILEPICT {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userHMETAFILEPICT_0 as FromIntoMemory>::from_bytes(&from[8..8 + 16]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
...
pub struct userHMETAFILEPICT_0 {
    pub hInproc: i32,
    pub hRemote: MutPtr<remoteMETAFILEPICT>,
    pub hInproc64: i64,
}
#[doc = "*Required namespaces: 'Windows.Win32.System.Com'*"]
#[cfg(dummy_option_that_does_not_exist)]
...
impl FromIntoMemory for userHPALETTE {
    fn from_bytes(from: &[u8]) -> Self {
        assert_eq!(from.len(), 24u32 as usize);
        let f_fContext = <i32 as FromIntoMemory>::from_bytes(&from[0..0 + 4]);
        let f_u = <userHPALETTE_0 as FromIntoMemory>::from_bytes(&from[8..8 + 16]);
        Self {
            fContext: f_fContext,
            u: f_u,
        }
