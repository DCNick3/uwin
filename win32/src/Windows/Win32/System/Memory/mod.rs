...
impl FromIntoMemory for MEM_EXTENDED_PARAMETER {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_Anonymous2 =
            <MEM_EXTENDED_PARAMETER_1 as FromIntoMemory>::from_bytes(&from[8..8 + 8]);
        Self {
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.Anonymous2, &mut into[8..8 + 8]);
    }
    fn size() -> usize {
        16
    }
...
impl FromIntoMemory for PROCESS_HEAP_ENTRY {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_Anonymous = <PROCESS_HEAP_ENTRY_0 as FromIntoMemory>::from_bytes(&from[12..12 + 16]);
        Self {
            lpData: f_lpData,
            cbData: f_cbData,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.Anonymous, &mut into[12..12 + 16]);
    }
    fn size() -> usize {
        28
    }
...
impl FromIntoMemory for WIN32_MEMORY_REGION_INFORMATION {
    fn from_bytes(from: &[u8]) -> Self {
        ...
        let f_Anonymous =
            <WIN32_MEMORY_REGION_INFORMATION_0 as FromIntoMemory>::from_bytes(&from[8..8 + 4]);
        let f_RegionSize = <PtrRepr as FromIntoMemory>::from_bytes(&from[12..12 + 4]);
        let f_CommitSize = <PtrRepr as FromIntoMemory>::from_bytes(&from[16..16 + 4]);
        Self {
            AllocationBase: f_AllocationBase,
            AllocationProtect: f_AllocationProtect,
            Anonymous: f_Anonymous,
    ...
    fn into_bytes(self, into: &mut [u8]) {
        ...
        FromIntoMemory::into_bytes(self.RegionSize, &mut into[12..12 + 4]);
        FromIntoMemory::into_bytes(self.CommitSize, &mut into[16..16 + 4]);
    }
    fn size() -> usize {
        20
    }
...
pub trait Api {
    ...
    #[doc = "CreateMemoryResourceNotification from KERNEL32"]
    ...
    #[doc = "FreeUserPhysicalPages from KERNEL32"]
    ...
    #[doc = "HeapLock from KERNEL32"]
    fn HeapLock(&self, h_heap: HeapHandle) -> super::super::Foundation::BOOL {
        todo!("HeapLock")
    }
    #[doc = "HeapQueryInformation from KERNEL32"]
    ...
    #[doc = "HeapSetInformation from KERNEL32"]
    ...
    #[doc = "IsBadCodePtr from KERNEL32"]
    fn IsBadCodePtr(
        &self,
    ...
    #[doc = "IsBadReadPtr from KERNEL32"]
    fn IsBadReadPtr(
        &self,
    ...
    #[doc = "MapUserPhysicalPagesScatter from KERNEL32"]
    ...
    #[doc = "MapViewOfFile from KERNEL32"]
    fn MapViewOfFile(
        &self,
    ...
    #[doc = "MapViewOfFileEx from KERNEL32"]
    fn MapViewOfFileEx(
        &self,
        h_file_mapping_object: super::super::Foundation::HANDLE,
        dw_desired_access: FILE_MAP,
    ...
    #[doc = "OpenFileMappingW from KERNEL32"]
    fn OpenFileMappingW(
        &self,
        dw_desired_access: u32,
        b_inherit_handle: super::super::Foundation::BOOL,
    ...
    #[doc = "RtlCompareMemory from KERNEL32"]
    fn RtlCompareMemory(
        &self,
    ...
    #[doc = "VirtualAllocEx from KERNEL32"]
    fn VirtualAllocEx(
        &self,
        h_process: super::super::Foundation::HANDLE,
        lp_address: ConstPtr<::core::ffi::c_void>,
    ...
    #[doc = "VirtualFreeEx from KERNEL32"]
    fn VirtualFreeEx(
        &self,
        h_process: super::super::Foundation::HANDLE,
        lp_address: MutPtr<::core::ffi::c_void>,
    ...
    #[doc = "VirtualProtect from KERNEL32"]
    fn VirtualProtect(
        &self,
        lp_address: ConstPtr<::core::ffi::c_void>,
        dw_size: PtrRepr,
    ...
    #[doc = "VirtualProtectEx from KERNEL32"]
    fn VirtualProtectEx(
        &self,
        h_process: super::super::Foundation::HANDLE,
        lp_address: ConstPtr<::core::ffi::c_void>,
    ...
    #[doc = "VirtualQuery from KERNEL32"]
    fn VirtualQuery(
        &self,
        lp_address: ConstPtr<::core::ffi::c_void>,
    ...
    #[doc = "VirtualQueryEx from KERNEL32"]
    fn VirtualQueryEx(
        &self,
        h_process: super::super::Foundation::HANDLE,
        lp_address: ConstPtr<::core::ffi::c_void>,
    ...
    #[doc = "VirtualUnlock from KERNEL32"]
    fn VirtualUnlock(
        &self,
        lp_address: ConstPtr<::core::ffi::c_void>,
        dw_size: PtrRepr,
