...
pub const DebugHelper: ::win32::core::GUID =
    ::win32::core::GUID::from_u128(0x0bfcc060_8c1d_11d0_accd_00aa0060275c);
...
impl ::core::fmt::Debug for DebugPropertyInfo {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DebugPropertyInfo")
...
impl ::core::cmp::PartialEq for DebugPropertyInfo {
    fn eq(&self, other: &Self) -> bool {
        self.m_dwValidFields == other.m_dwValidFields
            && self.m_bstrName == other.m_bstrName
            && self.m_bstrType == other.m_bstrType
            && self.m_bstrValue == other.m_bstrValue
            && self.m_bstrFullName == other.m_bstrFullName
            && self.m_dwAttrib == other.m_dwAttrib
            && self.m_pDebugProp == other.m_pDebugProp
    }
}
...
pub struct DebugStackFrameDescriptor {
    ...
    pub punkFinal: ::core::option::Option<::win32::core::IUnknown>,
}
impl ::core::clone::Clone for DebugStackFrameDescriptor {
    fn clone(&self) -> Self {
        Self {
            pdsf: self.pdsf.clone(),
            dwMin: self.dwMin,
            dwLim: self.dwLim,
            fFinal: self.fFinal,
            punkFinal: self.punkFinal.clone(),
        }
    }
}
impl ::core::fmt::Debug for DebugStackFrameDescriptor {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DebugStackFrameDescriptor")
            .field("pdsf", &self.pdsf)
            .field("dwMin", &self.dwMin)
            .field("dwLim", &self.dwLim)
            .field("fFinal", &self.fFinal)
            .field("punkFinal", &self.punkFinal)
            .finish()
    }
}
impl ::core::cmp::PartialEq for DebugStackFrameDescriptor {
    fn eq(&self, other: &Self) -> bool {
        self.pdsf == other.pdsf
            && self.dwMin == other.dwMin
            && self.dwLim == other.dwLim
            && self.fFinal == other.fFinal
            && self.punkFinal == other.punkFinal
    }
}
...
impl ::core::fmt::Debug for DebugStackFrameDescriptor64 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DebugStackFrameDescriptor64")
            .field("pdsf", &self.pdsf)
            .field("dwMin", &self.dwMin)
            .field("dwLim", &self.dwLim)
            .field("fFinal", &self.fFinal)
...
>;
pub type PDEBUG_EXTENSION_CALL = ::core::option::Option<
    unsafe extern "system" fn(
        client: ::core::option::Option<IDebugClient>,
        args: ::win32::core::PCSTR,
    ) -> ::win32::core::HRESULT,
>;
...
>;
pub type PDEBUG_EXTENSION_KNOWN_STRUCT_EX = ::core::option::Option<
    unsafe extern "system" fn(
        client: ::core::option::Option<IDebugClient>,
        flags: u32,
        offset: u64,
...
pub type PDEBUG_EXTENSION_PROVIDE_VALUE = ::core::option::Option<
    unsafe extern "system" fn(
        client: ::core::option::Option<IDebugClient>,
        flags: u32,
...
>;
pub type PDEBUG_EXTENSION_QUERY_VALUE_NAMES = ::core::option::Option<
    unsafe extern "system" fn(
        client: ::core::option::Option<IDebugClient>,
        flags: u32,
        buffer: ::win32::core::PWSTR,
        bufferchars: u32,
...
pub union PROFILER_HEAP_OBJECT_OPTIONAL_INFO_0 {
    pub prototype: usize,
    pub functionName: ::win32::core::PCWSTR,
...
impl ::core::clone::Clone for PROFILER_HEAP_OBJECT_RELATIONSHIP {
    fn clone(&self) -> Self {
        Self {
            ...
            relationshipInfo: self.relationshipInfo,
...
impl ::core::cmp::PartialEq for PROFILER_HEAP_OBJECT_RELATIONSHIP {
    fn eq(&self, other: &Self) -> bool {
        self.relationshipId == other.relationshipId
            && self.relationshipInfo == other.relationshipInfo
...
pub union PROFILER_HEAP_OBJECT_RELATIONSHIP_0 {
    pub numberValue: f64,
    pub stringValue: ::win32::core::PCWSTR,
...
impl ::core::fmt::Debug for TEXT_DOCUMENT_ARRAY {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("TEXT_DOCUMENT_ARRAY")
